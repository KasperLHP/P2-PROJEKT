        ...
        req.on('end', function () {
            ...
            if(req.url == "/website.html"){
                if(post.datepicker !== ""){
                    // Oneway
                    if(post.datepicker3 == ""){
                        startJob(post.datepicker2, undefined, post.myInput3, post.myInput4, post.adltsQ1, post.theHiddenPrice1, post.theHiddenTel1);
                    ...
                    // Round trip
                        ...
                        startJob(post.datepicker, post.datepicker1, post.myInput1, post.myInput2, post.adltsQ, post.theHiddenPrice, post.theHiddenTel);
